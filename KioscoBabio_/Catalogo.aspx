...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <%-----------------------------------------------------------------------------------------------------------------------------------------------
        SCRIPT: AL APRETAR EL BOTÓN DE FAVORITOS SE CAMBIA EL ICONO DE LA ESTRELLA Y ADEMÁS SE AGREGA O QUITA DE LA LISTA DE FAVORITOS SEGÚN CORRESPONDA 
        -----------------------------------------------------------------------------------------------------------------------------------------%>
    ...
    <script type="text/javascript">
        ...
        window.sessionStorage.setItem('faveados', faveadosString); // guardo la lista en memoria

        function toggleFavorite(container, button) {
            var userId = <%= Session["UserId"] %>;
            var faveadosString = window.sessionStorage.getItem('faveados');
            var faveados = JSON.parse(faveadosString);
            ...
            $.ajax({
                ...
                error: function (xhr, status, error) {
                    alert("Error al agregar el artículo a favoritos: " + xhr.responseText);
                }
...
<%-------------------------------------------------------------------------------------------------------------------------------------------------
         SCRIPT 2: AL CARGAR LA PÁGINA PINTA DE AMARILLO LA ESTRELLA SI EL ELEMENTO ES FAVORITO, Y SINO LA DEJA SIN RELLENAR
    ----------------------------------------------------------------------------------------------------------------------------------------------%>
    <script type="text/javascript">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-9 col-lg-6">
                    <div class="form-group" style="background-color: azure; margin-top: 20px">
                ...
                <div class="col-md-3 col-lg-2 mx-md-auto">
                    <div class="form-group" style="margin-top: 10px">
                        <a class="text-decoration-none" id="btnFiltroAvanzado" style="margin-top:15px" onclick="toggleFiltroAvanzado()">Filtro Avanzado
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <div class="row mb-3">
                    <div class="col-md-12 col-lg-6"> <!-- Aquí añadimos col-md-12 y col-lg-6 -->
